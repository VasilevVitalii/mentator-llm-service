...
```typescript
{
  model: string;              // Имя модели (имя файла без .gguf)
  message: {
...
{
  duration: {
    promtMsec: number;        // Время обработки
